...
# urlparse changed to urllib in python3
...
class Client:
	...
	def getUrl(self, url):
		...
		return parse.urljoin('https://' + self.host, parse.urlunparse((rel.scheme, rel.netloc, path, rel.params, rel.query, rel.fragment)))
